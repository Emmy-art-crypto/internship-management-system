...
class AdminProfile extends Component {
  ...
  loadData(user) {
    // Defensive: ensure user and user.name exist
    if (!user || !user.name) {
      this.setState({
        data: {
          _id: "admin",
          ...
          username: this.props.admin?.username || "admin",
        },
      });
    } else {
  ...
  render() {
    // Defensive: fallback for undefined data
                    ...
                    <div className="form-row my-2">
                      <div className="col-sm-6">
                        ...
                        <input
                          ...
                          placeholder={data.name.firstname}
                          style={{ fontSize: '16px', padding: '10px', height: '40px' }}
                        />
                      </div>
                      <div className="col-sm-6">
                        Last Name:
                        <input
                          ...
                          name="lastname"
                          id="lastname"
                          placeholder={data.name.lastname}
                          className="form-control"
                          style={{ fontSize: '16px', padding: '10px', height: '40px' }}
                        />
                      </div>
